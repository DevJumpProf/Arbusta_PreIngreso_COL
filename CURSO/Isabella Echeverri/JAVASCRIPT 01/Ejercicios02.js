...
function esPar(num){
    ...
    return console.log(`¿El número ${num} que se ingresó es par? ${validacion}`);
}
esPar(3);
esPar(4);
...
function esMultiplo(num1,num2){
    ...
    return console.log(`¿El numero ${num1} es multiplo de ${num2}? ${multiplo}`);
}
esMultiplo(40,4)
...
/* ayuda: Para las notas 6, 8, 10 la media es 8 por tanto se califica como Notable */
 ...
 function notaPromedio(nota1, nota2, nota3) {  
...
function ingresarTipoMotor(tipoMotor) {      
